export const workDecode = [
    {value: 1, prop: 'Свердлення'},
...
export const materialDecode = [
    {value: 1, prop: 'Б\\Ц'},
    {value: 2, prop: 'Діамант'},
    {value: 3, prop: 'Дзеркало'},
    {value: 4, prop: 'Бронза'},
    {value: 5, prop: 'Графіт'},
...
export const sandblastingDecode = [
    {value: 1, prop: 'Повний Фоновий'},
    {value: 2, prop: '3/4 Фоновий'},
    {value: 3, prop: 'Половина Фоновий'},
    {value: 4, prop: '1/4 Фоновий'},
    {value: 5, prop: 'Фігурний'},
];
